...
from .common import init_CV, init_VinvB, init_log_steps, trunc_standard_normal, make_DPLR_HiPPO
...
def init_S5(d_state, d_model, **cfg):
    C_init = cfg.get("C_init", "lecun_normal")
    discretization = cfg.get("discretization", "zoh")
    dt_min = cfg.get("dt_min", 0.001)
    dt_max = cfg.get("dt_max", 0.1)
    conj_sym = cfg.get("conj_sym", True)
    clip_eigs = cfg.get("clip_eigs", False)
    bidirectional = cfg.get("bidirectional", False)
    blocks = cfg.get("num_blocks", 8)
